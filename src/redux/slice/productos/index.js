...
const productSlice = createSlice({
    ...
    reducers: {
        ...
        updateProductoArray: (state, action) => {
        ...
        deleteProductoArray: (state, action) => {
